    ...
    return (
      <div className='flex flex-col items-center'>
        <div className='w-full max-w-md'>
          ...
          <div className='kye-glass-card mx-auto' style={{ maxWidth: 315, paddingTop: 56, paddingBottom: 56 }}>
            ...
            {(hasUserAgreement || hasPrivacyPolicy) && (
              <div className='mt-6'>
                ...
                >
                  <Text size='small' className='kye-text'>
                    {t('我已阅读并同意')}
                    {hasUserAgreement && (
                      <>
                        <a
          ...
          <div className='kye-glass-card mx-auto' style={{ maxWidth: 315, paddingTop: 56, paddingBottom: 56 }}>
            ...
            <div className='kye-input space-y-4'>
              ...
              <div className='flex flex-col items-center pt-2'>
                <Button
                  className='kye-btn kye-btn-primary kye-btn-sm'
                  htmlType='submit'
